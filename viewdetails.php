...
<head>
<style>
body{background-image: url(paw.jpg) !important;}
#pet{margin-top:32%;}
...
#pet2 ul li{background: #c7c7c7;border-radius: 5px;padding: 10px 10px 10px 10px;list-style: none !important;color:#400040;float:left;margin-top:10px;margin-right:20px;list-style-type:circle;font-size:24px;border:1px solid #40040;margin-left:20px;}

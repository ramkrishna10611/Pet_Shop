...
$query=$con->prepare("select *from petdetails where pet_type='bird' order by 1 desc LIMIT 0,4");
		$query->execute();
		echo"<div id='pet1'>
<h1 style='text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;padding-left:10px;margin-left:60px;margin-top:400px;width:92%;background:#425298;color:#fff;text-align:left;height:40px;line-height:40px;font-size:23px;border-radius:4px;'>BIRDs</h1>";
		while($row=$query->fetch()):
